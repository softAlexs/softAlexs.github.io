...
* 杭州小拇指汽车维修科技股份有限公司
* 2016 年 2 月 - 至今 
* 管理移动端开发团队，参与产品前期设计及建议。
* 完成全国700+门店全部使用的目标，实现SA订单转化率计算与高毛利业务的云推送模块；
* 帮助店主实现对门店的日常管理及财务报表统计。
* 负责公司C端项目研发、架构设计，提供iOS框架代码及功能组件。
* 优化产品的性能及奔溃信息的记录解决，使用react-native实现客户端的跨平台开发。

### iOS开发工程师
* 658金融网
* 2015 年 7 月 - 2016 年 2 月 
* 开发及维护公司金融理财App产品，后期负责独立开发一款直播App。
* 对公司已有项目进行代码优化和项目提交，公司系统框架搭建，管理iOS小组开发人员 。
* 金融理财App完成两次架构及UI迭代升级，appstore下载量突破50W+。
* 直播App实现独立的即时通讯长链接服务，完成直播服务接入及测试上线。

### iOS开发工程师
* 上海东方传媒公司(宝盈股份)
* 2014 年 7 月 - 2015 年 6 月
* 负责手机软件开发，App高级界面搭建设计，业务逻辑开发，参与后台数据接口集成。
* 基于Visual Studio进行企业管理软件开发，参与服务平台及应用软件开发。
* 完成公司要求的手机软件设计、编码和测试工作。搭建企业内部通信系统及网络维护工作。



## 博客

**GitHub: **https://github.com/softAlexs

> 如果你喜欢这个效果，Fork [我的项目](https://github.com/softAlexs/softalexs.github.io)，打造你自己的简历！`;
